...
Postcode and address elements in the new data are subject to Royal Mail copyright. The Royal Mail(address.management@royalmail.com) confirmed on the 25th August 2020 that this new data can be shared by both by Bin Chi and UKDA with certain restrictions namely:
